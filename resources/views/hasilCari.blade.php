...
@section('section')
    ...
    <div class="text-white">
        ...
        <div class="mx-2 p-2" style="background-color: rgba(156, 173, 206, 0.47) ;border-radius: 10px;">
        ...
        @if (!$events->isEmpty())
            ...
            @foreach ($events as $event)
                <div class="ms-5 p-2 " style="background-color: rgba(156, 173, 206, 0.47) ;border-radius: 25px;">
        ...
        @if (!$berita->isEmpty())
            ...
            @foreach ($berita as $item)
                <div class="mx-5"
                    style="border-radius: 20px; background-color:rgba(173, 216, 230, 0.5)">
            ...
            <ul style="list-style: none;">
                @foreach ($kompetisi as $item)
                    <div class="p-2" style="border-radius: 25px; background-color: rgba(74, 94, 206, 0.555);">
                        <li>
                            <h2 style="color:rgba(150, 208, 255, 1)"><a
                                    href="/kompetisi/{{ $item->id }}">{{ $item->nama }}</a></h2>
                            <p>{{ $item->keterangan }}</p>
